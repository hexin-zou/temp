/*
 ...
 Source Schema         : lersosa-workflow

 Target Server Type    : MySQL
 Target Server Version : 90300 (9.3.0)
 File Encoding         : 65001

 Date: 07/08/2025 23:42:39
*/
...
CREATE TABLE `wf_category`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uni_category_code`(`category_code` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程分类' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wf_category
-- ----------------------------
INSERT INTO `wf_category` VALUES (1, 'OA', 'OA', 0, 0, '000000', 103, 1, '2025-08-03 11:05:10', 1, '2025-08-03 11:05:10');
...
CREATE TABLE `wf_definition_config`  (
  ...
  `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uni_definition_id`(`definition_id` ASC) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '流程定义配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wf_form_manage`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单管理' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of wf_form_manage
-- ----------------------------
INSERT INTO `wf_form_manage` VALUES (1, '请假申请', 'static', '/workflow/leaveEdit/index', NULL, '000000', 103, 1, '2025-08-03 11:05:10', 1, '2025-08-03 11:05:10');
...
CREATE TABLE `wf_node_config`  (
  ...
  `tenant_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '租户编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '节点配置' ROW_FORMAT = Dynamic;
...
CREATE TABLE `wf_task_back_node`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '节点审批记录' ROW_FORMAT = Dynamic;
