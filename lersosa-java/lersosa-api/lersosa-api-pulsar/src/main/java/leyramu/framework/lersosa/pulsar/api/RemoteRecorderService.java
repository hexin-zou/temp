 ...
 * @since 2025/1/16
 */
public interface RemoteRecorderService {

    /**
     * 新增脉冲星.
     *
     * @param remoteNewPulsar 脉冲星
     * @return 是否新增成功
     */
    Boolean saveMatchByBo(RemotePulsarMatchBo remoteNewPulsar);
     ...
     * @return Boolean
     */
    Boolean getPulsarInfo(String name);
}
