...
import leyramu.framework.lersosa.common.ai.factory.PdfFontFactory;
...
public class PdfResourceStrategy implements ResourceProcessingStrategy {
    ...
    public void process(Resource resource, VectorStore vectorStore) {
        vectorStore.add(new TokenTextSplitter().split(pdfFontFactory.handlePdf(resource)));
    }
}
