...
package leyramu.framework.lersosa.ai.qianfan.config;

import leyramu.framework.lersosa.ai.qianfan.tool.QianFanTools;
...
public class QianFanAiConfig extends BaseAiConfig<QianFanChatModel, QianFanEmbeddingModel, QianFanTools> {
     ...
     */
    public QianFanAiConfig(QianFanChatModel chatModel, QianFanEmbeddingModel embeddingModel) {
     ...
     */
    @Override
    @Bean("ingestTermOfServiceToQianFanVectorStore")
    public CommandLineRunner ingestTermsOfServiceToVectorStore(
        @Qualifier("qianFanVectorStore") VectorStore vectorStore, ResourcePatternResolver resourcePatternResolver) {
     ...
     */
    @Override
    @Bean("qianFanChatClient")
    @ConditionalOnBean(QianFanTools.class)
    public ChatClient chatClient(@Qualifier("qianFanChatMemory") ChatMemory chatMemory, QianFanTools qianFanTools, ToolCallbackProvider mcpTools) {
        return super.chatClient(chatMemory, qianFanTools, mcpTools);
    }
}
