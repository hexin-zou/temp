...
package leyramu.framework.lersosa.ai;
...
public class LersosaAiApplication {
    ...
    public static void main(String[] args) {
        CustomSpringApplication application = new CustomSpringApplication(LersosaAiApplication.class);
