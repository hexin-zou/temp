...
public interface RecorderServiceI {
     ...
     * @return 记录脉冲星
     */
    RecorderVo queryByName(String name);
     ...
     * @return 记录脉冲星分页列表
     */
    TableDataInfo<RecorderVo> queryPageList(RecorderBo bo, PageQuery pageQuery);
     ...
     * @return 记录脉冲星列表
     */
    List<RecorderVo> queryList(RecorderBo bo);
     ...
     * @return 是否新增成功
     */
    Boolean insertByBo(RecorderBo bo);
     ...
     * @return 是否修改成功
     */
    Boolean updateByBo(RecorderBo bo);
