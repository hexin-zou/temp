...
@AutoMapper(target = PulsarE.class, reverseConvertGenerate = false)
public class PulsarBo extends BaseEntity {
     ...
     * 租户 ID.
     */
    @NotNull(message = "租户 ID不能为空", groups = {EditGroup.class})
     ...
     * 天空赤道坐标 - 赤经.
     */
    @NotBlank(message = "天空赤道坐标系坐标不能为空", groups = {AddGroup.class, EditGroup.class})
     ...
     * 天空银道坐标 - 银经.
     */
    @NotNull(message = "天空银道坐标系不能为空", groups = {AddGroup.class, EditGroup.class})
