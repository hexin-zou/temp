...
package leyramu.framework.lersosa.pulsar;
...
public class LersosaPulsarApplication {
    ...
    public static void main(String[] args) {
        CustomSpringApplication application = new CustomSpringApplication(LersosaPulsarApplication.class);
